...
function AccountsEmployeeRateCard() {
  ...
  const handleResetDefaults = () => {
    if (window.confirm("Reset all GL1, GL2, GL3 employee rates to default values?")) {
    ...
    <div className="rateCardContainer">
      ...
      {savedSuccess && (
        <div className="rateCardAlertSuccess">
          ✓ Employee Rate Card Saved Successfully! PayRun calculations for GL1, GL2, GL3 have been updated.
        </div>
      )}
      ...
      <div className="rateCardGrid">
        ...
        <div className="levelCard">
          <div className="levelCardHeader level1Header">
            ...
            <h3>GL1 Employee Rate (Level 1)</h3>
          </div>
        ...
        <div className="levelCard">
          <div className="levelCardHeader level2Header">
            ...
            <h3>GL2 Employee Rate (Level 2)</h3>
          </div>
        ...
        <div className="levelCard">
          <div className="levelCardHeader level3Header">
            ...
            <h3>GL3 Employee Rate (Level 3)</h3>
          </div>
...
export default AccountsEmployeeRateCard;
