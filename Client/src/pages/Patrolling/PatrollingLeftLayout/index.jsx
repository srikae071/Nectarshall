...
import "./index.css";
import PatrollingNavbar from "../PatrollingNavbar/index.jsx";
import { EmployeeContext } from "../EmployeeContext.js";
function PatrollingLeftLayout({ children }) {
              ...
              <div className="schedulePanel">
                ...
                <div className="section">
                  ...
                  <div className="btnGroup">
                    <button
                      className="activeBtn"
                      onClick={() => navigate("/PatrollingSchedule")}
                    >
                      Employees
                    </button>
                    <button onClick={() => navigate("/PatrollingSites")}>
                      Routes
                    </button>
                  </div>
                </div>
...
export default PatrollingLeftLayout;
